...
const client = new OpenAI({
  apiKey: process.env.OPENAI_API_KEY, // set in Vercel → Settings → Environment Variables
});
...
`;
    ...
    try {
      ...
      return res
        .status(500)
        .json({ error: "Invalid JSON returned", raw: completion.choices[0].message.content });
    }
